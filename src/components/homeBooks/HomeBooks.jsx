...
const HomeBooks = () => {
    ...
    return (
        <div className="w-11/12 pb-2 md:pb-4 lg:pb-8 m-auto flex flex-col">
            <h2 className="text-xl md:text-2xl lg:text-3xl text-center font-bold">All books</h2>
            <div className="m-auto my-4 lg:my-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-6 gap-4">
                {
