...
const Team = () => {
    return (
        <div className='relative'>
            <div>
                <img src={bg} alt="" className='h-[450px] w-full object-cover object-top' />
            </div>
            <div className='absolute w-full flex items-center flex-wrap justify-around md:flex-nowrap bottom-0 gap-2 md:bottom-1/4 px-2 md:px-8 lg:px-12'>
